...
export const eventSchema = z.object({
  ...
  startTime: z.object({ hour: z.number(), minute: z.number() }, { error: getValidationMessage("validation.startTimeRequired") }),
  endDate: z.date({ error: getValidationMessage("validation.endDateRequired") }),
  endTime: z.object({ hour: z.number(), minute: z.number() }, { error: getValidationMessage("validation.endTimeRequired") }),
  color: z.enum(["blue", "green", "red", "yellow", "purple", "orange", "gray"], { error: getValidationMessage("validation.colorRequired") }),
});
