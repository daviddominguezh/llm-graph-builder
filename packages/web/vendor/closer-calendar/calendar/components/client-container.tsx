...
import { DndProviderWrapper } from "@cc/calendar/components/dnd/dnd-provider";

import { CalendarHeader } from "@cc/calendar/components/header/calendar-header";
import { CalendarYearView } from "@cc/calendar/components/year-view/calendar-year-view";
import { CalendarMonthView } from "@cc/calendar/components/month-view/calendar-month-view";
import { CalendarAgendaView } from "@cc/calendar/components/agenda-view/calendar-agenda-view";
import { CalendarDayView } from "@cc/calendar/components/week-and-day-view/calendar-day-view";
import { CalendarWeekView } from "@cc/calendar/components/week-and-day-view/calendar-week-view";
...
export function ClientContainer({ view, hideEdit, handleChangeView }: IProps) {
  ...
  const filteredEvents = useMemo(() => {
    return events.filter((event) => {
      ...
      if (view === "week") {
        ...
        weekStart.setDate(selectedDate.getDate() - mondayBasedDayOfWeek);
  ...
  return (
    <div className="twcal-theme twcal:h-full twcal:overflow-hidden twcal:flex twcal:flex-col">
      <CalendarHeader
        view={view}
