  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="[&>svg]:size-full grid place-content-center text-current transition-none"
      >
        <CheckIcon
        />
      </CheckboxPrimitive.Indicator>
