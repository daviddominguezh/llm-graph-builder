// FE mirror of the api RFC-6901 pointer setter (packages/api/src/runtime/jsonPointer.ts).
// The web package cannot import the api internal path, so the logic is duplicated here.
// Immutable / copy-on-write: shallow-clones the root and each traversed container.
