  ...
  return (
    <thead>
      <tr className="border-b">
        <th className="px-3 py-2 text-left text-[11px] font-medium text-muted-foreground">{t('tenantColumn')}</th>
        <th className="px-3 py-2 text-left text-[11px] font-medium text-muted-foreground">{t('githubAccountColumn')}</th>
        <th className="px-3 py-2 text-left text-[11px] font-medium text-muted-foreground">{t('repositoryColumn')}</th>
        <th className="px-3 py-2 text-left text-[11px] font-medium text-muted-foreground">{t('statusColumn')}</th>
      </tr>
    </thead>
  );
}
