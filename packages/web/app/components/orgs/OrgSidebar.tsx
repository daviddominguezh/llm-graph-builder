...
export function OrgSidebar({ org }: OrgSidebarProps) {
  ...
  return (
    <aside
      className={`absolute left-1.5 top-1.5 bottom-1.5 z-10 flex flex-col gap-4 rounded-xl border bg-background p-2 transition-[width] duration-100 ${sidebar.collapsed ? 'w-13' : 'w-48 shadow-lg'}`}
