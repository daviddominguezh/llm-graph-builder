  ...
  return (
    <Link
      ...
      className={`group flex gap-2 rounded-md pr-2 py-0 ${
        active ? 'bg-input dark:bg-input/30 text-foreground' : 'hover:bg-input dark:hover:bg-input/20 text-foreground'
      }`}
    >
...
export function AgentsSidebar({ agents: serverAgents, orgId, orgSlug }: AgentsSidebarProps) {
  ...
  return (
    <GlassPanel variant="background" className="relative flex h-[calc(100%-var(--spacing)*1.5)] w-[240px] shrink-0 flex-col pointer-events-auto rounded-xl">
