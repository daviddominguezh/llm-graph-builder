 ...
 * on the row, per-shape pulse on each `bg-muted` block.
 */
  ...
  return (
    ...
    >
      <div className="flex w-full items-center overflow-hidden py-1 pl-1.5 pr-3 border-l-2 border-transparent">
        <div className="w-[30px] h-[30px] rounded-full bg-muted shrink-0 animate-pulse" />
        <div className="flex flex-col gap-1.5 flex-1 min-w-0 ml-3">
          <div className="flex items-center justify-between gap-2">
            <div className="h-3 w-24 rounded bg-muted animate-pulse" />
            <div className="h-2 w-8 rounded bg-muted shrink-0 animate-pulse" />
          </div>
