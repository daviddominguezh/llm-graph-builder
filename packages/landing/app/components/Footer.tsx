...
export function Footer() {
  return (
    <footer className="border-t border-dashed border-[#061b31]/8 bg-white px-10 py-16">
      <div className="mx-auto max-w-[1232px]">
        ...
        <div className="mt-14 flex items-center justify-between border-t border-dashed border-[#061b31]/8 pt-6">
