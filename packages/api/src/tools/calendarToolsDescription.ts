export const LIST_CALENDARS_DESCRIPTION =
  'List every calendar the connected account can access (primary, shared, and secondary calendars). Returns each calendar id, display name, timezone, and whether it is the primary calendar. Use to discover which calendar ids can be used with other calendar tools.';
