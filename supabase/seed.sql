...
(v_org_id, 'Slack', 'Send and read Slack messages, manage channels, and search conversations across your workspace.', 'Communication', 'token', 'https://icon.horse/icon/slack.com',
...
(v_org_id, 'Vercel', 'Manage Vercel projects, deployments, and logs. Search Vercel documentation. Authenticates via OAuth.', 'DevOps & Infrastructure', 'oauth', 'https://cdn.simpleicons.org/vercel',
...
(v_org_id, 'Canva', 'Access Canva Connect API to manage designs, brand assets, and templates.', 'Design', 'token', 'https://icon.horse/icon/canva.com',
