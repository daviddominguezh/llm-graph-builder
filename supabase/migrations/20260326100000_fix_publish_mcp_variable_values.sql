-- ============================================================================
-- Fix publish_version_tx to include variable_values and library_item_id
-- in MCP server snapshots. Without these, published agents cannot resolve
-- {{VAR}} template variables in MCP transport headers.
-- ============================================================================
