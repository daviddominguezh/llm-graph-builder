...
-- Drop views that depend on agent_sessions.tenant_id before altering the column type
DROP VIEW IF EXISTS public.agent_sessions_with_cost;
...
-- Recreate the view that was dropped before the ALTER
